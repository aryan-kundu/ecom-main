  ...
  <div className="container px-5 py-24 mx-auto">
    <div className="lg:w-4/5 mx-auto flex flex-wrap">
      <div className="lg:w-1/2 w-full lg:pr-10 lg:py-6 mb-6 lg:mb-0">
        ...
        <h1 className="text-gray-900 text-3xl title-font font-medium mb-4">Wear the code</h1>
        <div className="flex mb-4">
          <a className="flex-grow text-pink-500 border-b-2 border-gray-300 py-2 text-lg px-1">Description</a>
